...
class ProcessStatusId(BaseModel):
    """
    ProcessStatusId
    """ # noqa: E501
    process_status_id: StrictStr = Field(description="The process status id.", alias="processStatusId")
    __properties: ClassVar[List[str]] = ["processStatusId"]
